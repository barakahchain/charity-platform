...
describe("ProjectFactory + Project Integration", function () {
  ...
  before(async () => {
    ...
    const factoryAddress = "0x66104d4a199df29f829af78cc9280505aeae302c";
    const implementationAddress = "0x43dF1e8F72327359F8069d5E0EB75Ef09E179E30";

    factory = await viem.getContractAt("ProjectFactory", factoryAddress);
    projectImpl = await viem.getContractAt("Project", implementationAddress);
  });
